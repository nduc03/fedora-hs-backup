...
mkdir -p "$SCRIPT_DIR/caddy_config"
mkdir -p "$SCRIPT_DIR/webroot"
#* ...
...
echo ">>> Copying $TARGET_FILE to $SYSTEMD_DIR"
$SUDO mkdir -p "$SYSTEMD_DIR"
$SUDO mv "$SCRIPT_DIR/$TARGET_FILE" "$SYSTEMD_DIR/$TARGET_FILE"
